...
/**
 * Метод сложения - теперь асинхронный с Promise
 * В JS: await NativeCalculator.add(5, 3)
 */
- (void)add:(double)a
          b:(double)b
...
/**
 * Метод умножения - теперь асинхронный с Promise
 * В JS: await NativeCalculator.multiply(4, 7)
 */
